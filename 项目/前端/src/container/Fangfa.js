        ...
        return (
            <div style={{
                ...
                <div>
                    ...
                    <div style={{float:"left",marginLeft:"7px",width:"95%",borderRadius:"8px",backgroundColor:"#fff",lineHeight:"25px",border:'solid 1px gray',
                    background:'url(../img/fangfa1.png) center center /  100% 100%  no-repeat',
                }}>
                    ...
                    <div style={{float:"left",marginLeft:"7px",width:"95%",borderRadius:"8px",backgroundColor:"#fff",lineHeight:"25px",border:'solid 1px gray',
                    background:'url(../img/fangfa4.jpg) center center /  100% 100%  no-repeat',}}>
