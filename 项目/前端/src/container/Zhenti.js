        ...
        return (
            <div>
                ...
                <div style={{
                    ...
                    <Link to='/juanliu'>
                    <span style={{float:'right',lineHeight:'100px',marginRight:'10%'}}>2019北京市高考卷数学卷>></span>
                    </Link>
                </div>
                <WhiteSpace/>
                <div style={{
                    ...
                    <Link to='/juanqi'>
                    <span style={{float:'right',lineHeight:'100px',marginRight:'10%'}}>2019天津市高考卷数学卷>></span>
                    </Link>
                </div>
                <WhiteSpace/>
                <div style={{
                    ...
                    <Link to='/juanba'>
                    <span style={{float:'right',lineHeight:'100px',marginRight:'10%'}}>2019山东省高考卷数学卷>></span>
                    </Link>
                </div>
                <WhiteSpace/>
                <div style={{
                    ...
                    <Link to='/juansan'>
                    <span style={{float:'right',lineHeight:'100px',marginRight:'10%'}}>2019浙江省高考卷数学卷>></span>
                    </Link>
                </div>
                <WhiteSpace/>
                <div style={{
                    ...
                    <Link to='/juanjiu'>
                    <span style={{float:'right',lineHeight:'100px',marginRight:'10%'}}>2019上海市高考卷数学卷>></span>
                    </Link>
                </div>
                <WhiteSpace/>
                <div style={{
                    ...
                    <Link to='/juanshi'>
                    <span style={{float:'right',lineHeight:'100px',marginRight:'10%'}}>2019江苏省高考卷数学卷>></span>
                    </Link>
                </div>
                <WhiteSpace/>
            </div>
