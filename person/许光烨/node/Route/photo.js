...
//修改密码和昵称
let chsql="UPDATE sqlstudent SET spwd=$1 WHERE sname=$2"
let chsql1="UPDATE sqlstudent SET nicheng=$1 WHERE sname=$2"
...
let updatesql = 'UPDATE sqlstudent SET sclass=$1'
app.post('/information',(req,res)=>{
    ...
    form.parse(req, function(err, fields, files) {
        ...
        pool.query(selsql, (error,results,fields)=> {
            ...
            if (error) console.log(error.message);
            // for(let i=0;i<results.rows.length;i++){
            //     if(results.rows[i].sphone === phone){
            //         isregister = true;
            //         break;
            //     }
            // }
