                        ...
                        <div style={{
                            ...
                            <div>
                                <img src="../img/ti-1.jpg" style={{
                                    ...
                                    height:'108px',
                                    float:'left',
                                    borderRight:'solid 1px #099ff5',
                                    boxShadow:'1px 0px 1px gray'
                                }}/>
                                <div style={{
                                    marginTop:'0',
                                    marginLeft:'3%',
                                ...
                                }}><p style={{width:"100%",marginTop:'9%',marginLeft:'18%',float:'left',fontSize:'18px',fontFamily:'Kaiti',color:'black'}}>函数</p>
                                <p style={{marginTop:'0px',marginLeft:'6%',float:'left',fontSize:'14px',lineHeight:"20px",fontFamily:'Kaiti',color:'black'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;——学数学，绝不会有过份的努力</p>
                                 </div>
                            </div>
                            </Link>
                        </div>
