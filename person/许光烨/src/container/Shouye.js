        ...
        return (
            <div style={{height:'800px',width:'1400px',margin:"0 auto"}}>
                ...
                <div style={{width: '1050px',height: '800px',float: 'left'}}>
                    <div style={{width: '1050px',height: '80px'}}>
                        <div style={{width: '1050px',height: '80px',float:'left'}}>
                    ...
                    <div style={{width: '1050px',height: '40px',float: 'left'}}>
                        <p style={{marginLeft:'100px',float:"left"}}>
                            {
                                this.state.data.map((item,index)=>
                                <span key={index} style={{fontSize:'30px'}}>{item.sname}</span>
                                )
                            }
                        </p>
                        <div className='time' style={{fontSize:"22px",float:"left",marginLeft:"700px",marginTop:"-60px"}} >
                            <FontAwesome name='calendar' />{this.state.time}
                        </div>
                    </div>
