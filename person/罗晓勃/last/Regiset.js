        ...
        return (
            <div style={{
                ...
                <form onSubmit={this.onSubmit.bind(this)} style={{
                    ...
                    <input type="text" autocomplete="off" placeholder="昵称" onChange={this.handleChange2}  id="pwd"  name="pwd" style={{
                        width:'97%',
                        height:'40px',
                        position:'absolute',
                        top:'15%',
                    ...
                    <WhiteSpace/>
                    <input type="text" autocomplete="off" placeholder="姓名" onChange={this.handleChange3}  id="pwd"  name="" style={{
                        width:'97%',
                        height:'40px',
                        position:'absolute',
                        top:'45%',
